...
static void utc_tone_player_start_ex_p(void);
static void utc_tone_player_start_ex_n(void);
static void utc_tone_player_stop_started_by_ex_p(void);
...
struct tet_testlist tet_testlist[] = {
	...
	{ utc_tone_player_start_ex_p , 5 },
	{ utc_tone_player_start_ex_n , 6 },
	{ utc_tone_player_stop_started_by_ex_p, 7 },
	{ NULL, 0 },
};
...
static void utc_tone_player_start_ex_p(void){
	int ret;
	ret = tone_player_start_ex(TONE_TYPE_DEFAULT, SOUND_TYPE_MEDIA,1000, NULL, 1);
	MY_ASSERT(__func__, ret== TONE_PLAYER_ERROR_NONE , "tone_player_start fail");
	dts_pass(__func__, "PASS");
}
static void utc_tone_player_start_ex_n(void){
	int ret;
	ret = tone_player_start_ex(-1, SOUND_TYPE_MEDIA ,1000, NULL, 0);
	MY_ASSERT(__func__, ret != TONE_PLAYER_ERROR_NONE , " not allow null");
	dts_pass(__func__, "PASS");
}
...
static void utc_tone_player_stop_started_by_ex_p(void){
	int ret;
	int id;
	ret = tone_player_start_ex(TONE_TYPE_DEFAULT, SOUND_TYPE_MEDIA,1000, &id, 1);
	ret = tone_player_stop(id);
	MY_ASSERT(__func__, ret== TONE_PLAYER_ERROR_NONE , "tone_player_stop fail");
	dts_pass(__func__, "PASS");
}
